#!/usr/bin/env python3
"""
Generates ti-element.png — a periodic-table-style element icon.

Uses Playwright to render DM Serif Display with browser-accurate
...
OUT_PATH  = HERE / "assets" / "images" / "ti-element.png"
